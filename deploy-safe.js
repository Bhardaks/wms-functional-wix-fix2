...
console.log('🚀 WMS Safe Deployment Script');
console.log('===============================\n');
  ...
  try {
    ...
    if (gitStatus.trim()) {
      ...
      if (proceed.toLowerCase() === 'y' || proceed.toLowerCase() === 'yes') {
        ...
        const finalMessage = commitMessage || 'Update WMS system with data safety improvements';
...
Co-Authored-By: Claude <noreply@anthropic.com>"`, 'Creating commit');
    ...
    console.log('Your data is safe and changes are pushed to GitHub.');
